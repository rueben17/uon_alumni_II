...
# -------------------------------------------------------------------
# Scholarship applications (2026-08-11) -- Google Form applicant data
# plus the printed interview score sheet. Placed in this app rather
# than a new `scholarships` app per explicit instruction, reusing the
# existing app's migration history/admin site instead of standing up a
# new one for two models.
# -------------------------------------------------------------------
...
class ScholarshipApplication(models.Model):
    ...
    department = models.ForeignKey(Department, on_delete=models.PROTECT, related_name="scholarship_applications")
    faculty = models.ForeignKey(Faculty, on_delete=models.PROTECT, related_name="scholarship_applications")
