...
def contacts(request):
    ...
    return {
        ...
        "url_secretariat": f"{base}/secretariat/",
        "url_chapters":    f"{base}/chapters/",
        "url_partners":    f"{base}/partners/",
        "url_mission_vision": f"{base}/mission-vision/",
        "url_walk":        f"{base}/uon-alumni-walk/",
        "url_articles":    f"{base}/news/",
        ...
        "url_downloads":   f"{base}/downloads/",
        "url_newsletters": f"{base}/downloads/?category=newsletter",
        "url_careers":     f"{base}/careers/",
        # Standing pages -- one route (home:standing_page) behind all of
        # these, see apps/home/views.py's standing_page().
        "url_categories_benefits": f"{base}/page/categories-benefits/",
        "url_alumni_card":         f"{base}/page/alumni-card/",
        "url_corporates":          f"{base}/page/corporates/",
        "url_notable_alumni":      f"{base}/page/notable-alumni/",
        "url_agm":                 f"{base}/page/agm/",
        "url_consultancy_training": f"{base}/page/consultancy-training/",
        "url_terms":               f"{base}/page/terms/",
        "url_privacy":             f"{base}/page/privacy/",
        "url_shop":                f"{base}/page/shop/",
